...
parser.add_argument('--bboxes_folder', default='results_on_test_images_part2/ADNet_RL_epoch29-0.5', type=str, help='location where bboxes files are saved')
parser.add_argument('--save_plot_folder', default='results_on_test_images/ADNet_RL_epoch29-0.5', type=str, help='save plots folder')
